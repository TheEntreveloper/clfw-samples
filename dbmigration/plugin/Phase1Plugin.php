 ...
 * @package app\plugin
 */
class Phase1Plugin implements \cl\contract\CLPlugin, CLInjectable
{
    private $logger;
    ...
    public function run(): CLResponse
    {
        ...
        $entity = requestToEntity('article', ['title', 'description', 'content'], $this->clServiceRequest->getCLRequest());
