 ...
 * @package app\plugin
 */
class Phase3Plugin implements \cl\contract\CLPlugin, CLInjectable
{
    private $logger;
    ...
    public function run(): CLResponse
    {
        ...
        $entity = requestToEntity('article', ['title', 'description', 'content', 'datepublished', 'author'], $this->clServiceRequest->getCLRequest());
