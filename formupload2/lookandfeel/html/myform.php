            ...
            <div class="col-lg-10 mx-auto">
                ...
                <form method="post" action="index.php" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" size="" name="metadata" value="<?= isset($metadata) ? $metadata : '' ?>" class="form-control" placeholder="enter comma separated keywords for your document" aria-label="metadata"
